...
class MedicationExpectedDosesEndpointTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.medication = Medication.objects.create(
            name="Test Medication", dosage_mg=500, prescribed_per_day=2
        )
        self.valid_url = reverse(
            "medication-expected-doses", kwargs={"pk": self.medication.id}
        )
    ...
    def test_medication_with_zero_prescribed_per_day_returns_400(self):
        ...
        medication_zero = Medication.objects.create(
            name="Zero Prescribed Medication", dosage_mg=100, prescribed_per_day=0
        )
